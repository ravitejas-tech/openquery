...
export function emitIndex(files: { queries: boolean; mutations: boolean; infinite: boolean }): string {
    const lines = [GENERATED_HEADER, '', `export * from './types.js';`, `export * from './requests.js';`]
